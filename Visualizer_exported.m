classdef Visualizer_exported < matlab.apps.AppBase
    ...
    properties (Access = public)
        ...
        Choosemp3wavfileButton        matlab.ui.control.Button
        ...
        FrResolutionMethodDropDownLabel  matlab.ui.control.Label
        FrResolutionMethodDropDown    matlab.ui.control.DropDown
    end
    ...
    methods (Access = private)
        ...
        % Button pushed function: Choosemp3wavfileButton
        function Choosemp3wavfileButtonPushed(app, event)
            % Kodikas gia to "Choose a mp3 file"  Button
        ...
        function SpectrumscopeButtonPushed(app, event)
          ...
          % Kwdikas gia to Spectrum Scope Button
           ...
           scope = dsp.SpectrumAnalyzer('SampleRate',fileReader.SampleRate, ...
                ...
                'Span',app.span_SpSc,...
                'FrequencyResolutionMethod',app.frResolutionMethod_SpSc,...
        ...
        % Value changed function: FrResolutionMethodDropDown
        function FrResolutionMethodDropDownValueChanged(app, event)
            value = app.FrResolutionMethodDropDown.Value;
            
            if strcmp(value,'RBW')
                app.frResolutionMethod_SpSc = 'RBW';
            else
                app.frResolutionMethod_SpSc = 'WindowLength';
            end
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            % Create Choosemp3wavfileButton
            app.Choosemp3wavfileButton = uibutton(app.LeftPanel, 'push');
            app.Choosemp3wavfileButton.ButtonPushedFcn = createCallbackFcn(app, @Choosemp3wavfileButtonPushed, true);
            app.Choosemp3wavfileButton.BackgroundColor = [0.9098 0.7294 0.2];
            app.Choosemp3wavfileButton.Position = [39 255 183 22];
            app.Choosemp3wavfileButton.Text = 'Choose .mp3/.wav file';
            ...
            app.PlotTypeDropDown.Tooltip = {'"Stem" ÿ The scope displays the input signal as circles with vertical lines extending down to the x-axis at each of the sampled values.'; '"Line" ÿ The scope displays the input signal as lines connecting each of the sampled values.'; '"Stairs" ÿ The scope displays the input signal as a stair-step graph. A stair-step graph is made up of only horizontal lines and vertical lines. Each horizontal line represents the signal value for a discrete sample period and is connected to two vertical lines. Each vertical line represents a change in values occurring at a sample. Stair-step graphs are useful for drawing time history graphs of digitally sampled data. '};
            ...
            app.PlorasMagnitudePhaseSwitchLabel.Tooltip = {'onÿ The scope plots the magnitude and phase of the input signal on two separate axes within the same active display.'; 'offÿ The scope plots the real and imaginary parts of the input signal on two separate axes within the same active display'};
            ...
            app.PlorasMagnitudePhaseSwitch.Tooltip = {'onÿ The scope plots the magnitude and phase of the input signal on two separate axes within the same active display.'; 'offÿ The scope plots the real and imaginary parts of the input signal on two separate axes within the same active display.'};
            ...
            app.ViewTypeDropDownLabel.Tooltip = {'"Spectrum" ÿ shows the power spectrum.'; '"Spectrogram" ÿ shows frequency content over time. Each line of the spectrogram is one periodogram. Time scrolls from the bottom to the top of the display. The most recent spectrogram update is at the bottom of the display. '; '"Spectrum and Spectrogram" ÿ shows a dual view of a spectrum and spectrogram.'};
            ...
            app.ViewTypeDropDown.Items = {'Spectrum', 'Spectrogram', 'Spectrum and spectrogram'};
            app.ViewTypeDropDown.ValueChangedFcn = createCallbackFcn(app, @ViewTypeDropDownValueChanged, true);
            app.ViewTypeDropDown.Tooltip = {'"Spectrum" ÿ shows the power spectrum.'; '"Spectrogram" ÿ shows frequency content over time. Each line of the spectrogram is one periodogram. Time scrolls from the bottom to the top of the display. The most recent spectrogram update is at the bottom of the display. '; '"Spectrum and Spectrogram" ÿ shows a dual view of a spectrum and spectrogram.'};
            ...
            app.FrScaleandSidesDropDownLabel.Tooltip = {'true ÿ Compute and plot two-sided spectral estimates. When the input signal is complex-valued, you must set this property to true.'; 'false ÿ Compute and plot one-sided spectral estimates. If you set this property to false, then the input signal must be real-valued.'; '"Log" ÿ displays the frequencies on the x-axis on a logarithmic scale. '; '"Linear" ÿ displays the frequencies on the x-axis on a linear scale. To use the "Linear" setting, you must also set the PlotAsTwoSidedSpectrum property to true.'; 'To use the "Log" setting the plot has to be one-sided.'};
            ...
            app.FrScaleandSidesDropDown.Tooltip = {'true ÿ Compute and plot two-sided spectral estimates. When the input signal is complex-valued, you must set this property to true.'; 'false ÿ Compute and plot one-sided spectral estimates. If you set this property to false, then the input signal must be real-valued.'; '"Log" ÿ displays the frequencies on the x-axis on a logarithmic scale. '; '"Linear" ÿ displays the frequencies on the x-axis on a linear scale. To use the "Linear" setting, you must also set the PlotAsTwoSidedSpectrum property to true.'; 'To use the "Log" setting the plot has to be one-sided.'};
            ...
            app.WindowLengthSpinnerLabel.Position = [469 130 88 22];
            ...
            app.WindowLengthSpinner.Position = [572 130 73 22];
            ...
            app.WindowDropDownLabel.Position = [256 160 48 22];
            ...
            app.WindowDropDown.Position = [319 160 100 22];
            ...
            % Create FrResolutionMethodDropDownLabel
            app.FrResolutionMethodDropDownLabel = uilabel(app.RightPanel);
            app.FrResolutionMethodDropDownLabel.BackgroundColor = [0.251 0.251 0.251];
            app.FrResolutionMethodDropDownLabel.HorizontalAlignment = 'right';
            app.FrResolutionMethodDropDownLabel.FontColor = [0.9098 0.7294 0.2];
            app.FrResolutionMethodDropDownLabel.Position = [257 130 121 22];
            app.FrResolutionMethodDropDownLabel.Text = 'Fr-Resolution Method';

            % Create FrResolutionMethodDropDown
            app.FrResolutionMethodDropDown = uidropdown(app.RightPanel);
            app.FrResolutionMethodDropDown.Items = {'RBW', 'Window Length'};
            app.FrResolutionMethodDropDown.ValueChangedFcn = createCallbackFcn(app, @FrResolutionMethodDropDownValueChanged, true);
            app.FrResolutionMethodDropDown.FontColor = [0.9098 0.7294 0.2];
            app.FrResolutionMethodDropDown.BackgroundColor = [0.251 0.251 0.251];
            app.FrResolutionMethodDropDown.Position = [398 130 61 22];
            app.FrResolutionMethodDropDown.Value = 'RBW';
    ...
    methods (Access = public)
        ...
        % Construct app
        function app = Visualizer_exported
